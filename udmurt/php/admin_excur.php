...
<div class="excur-block">
    ...
    <div style="display: flex; flex-direction: column; justify-content: space-around;">
        <div style="display: flex; flex-direction: column; align-items: flex-end;">
            ...
            onclick="$.post('./php/admin_excur_appoint.php', {id: <?echo $row['id'];?>, id_route: <?echo $row['id_route']?>}, function (data) {$('main').html(data);})">Подробнее...</button>
            <div class="excur-edit-btns">
                <a class="excur-edit-btn1">Редактировать</a>
                <a class="excur-edit-btn2">Удалить</a>
            </div>
        </div>
    </div>
</div>
